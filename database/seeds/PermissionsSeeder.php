...
class PermisionsSeeder extends Seeder {
    ...
    public function run()
    {
        ...
        $lista_moodle->display_name = 'generar lista para inscripci�n masiva aen Moodle';
        $lista_moodle->save();
        ...
        $ver_informes_academicos->display_name = 'ver los informes acad�micos generados por los profesores';
