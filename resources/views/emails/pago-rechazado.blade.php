        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-login">
                <div class="panel-body">
                    ...
                    Su pago de la actividad {{$curso->nombre}} por el monto de {{$pago_->monto}}Bs de la fecha {{$pago_->created_at->format('d-m-Y')}}
                    fue rechazado por el siguiente motivo:<br>
                    <ul>
                        <li>{{$motivo}}</li>
                    </ul>
                    <br>
                    Le recordamos que pude pagar la actividad en un máximo de tres(3) cuotas.<br><br>
