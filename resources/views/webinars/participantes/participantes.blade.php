            ...
            <div class="col-md-8 col-sm-8 opciones_part2">
                ...
                <div class="col-md-2 " style="">
                    @if(Entrust::can('ver_webinars'))
                        <a href="{{URL::to('/')}}/webinars/{{$webinar->id}}/grupos/participantes" type="button" class="btn btn-default" style="text-decoration: none"><span class="glyphicon glyphicon-remove"></span> Cancelar </a>
                    @endif
                </div>
                <div class="col-md-2 " style="">
