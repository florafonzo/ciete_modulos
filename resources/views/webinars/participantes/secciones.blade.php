        ...
        @if (!(Auth::guest()))
            ...
            <div class="col-md-8 col-sm-8 opciones_part2">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if(Entrust::can('listar_alumnos'))
                                            {!!Form::open(["url"=>"webinars/".$webinar->id."/grupos/".$seccion."/participantes",  "method" => "GET" ])!!}
                ...
                @if(Entrust::can('ver_cursos_profe'))
                    <a href="{{URL::to("/")}}/webinars " class="btn btn-default text-right"><span class="glyphicon glyphicon-chevron-left"></span> Regresar</a>
                @endif
            </div>
        @endif
    </div>
