            ...
            <div class="col-md-8 col-sm-8 opciones_part2">
                ...
                <div class="row">
                    <div class="col-md-6 col-md-offset-6">
                        {!!Form::open(["url"=>"webinars/".$webinar->id."/profesores/buscar",  "method" => "GET" ])!!}
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if(Entrust::can('eliminar_prof_webinar'))
                                                {!!Form::open(["url"=>"webinars/".$webinar->id."/profesores/".$profesor->id."/eliminar",  "method" => "delete", "id" => "eliminar_prof_web".$profesor->id ])!!}
