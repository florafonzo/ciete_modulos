            ...
            <div class="col-md-8 col-sm-8 opciones_part2">
                ...
                <div class="row">
                    <div class="col-md-6 col-md-offset-6">
                        {!!Form::open(["url"=>"actividades/".$curso->id."/modulos/".$modulo->id."/profesores/buscar",  "method" => "GET" ])!!}
                ...
                <div class="table-responsive">
                    <table class="table table-hover">
                            ...
                            @foreach($profesores as $index => $profesor)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if(Entrust::can('eliminar_prof_curso'))
                                                {!!Form::open(["url"=>"actividades/".$curso->id."/modulos/".$modulo->id."/profesores/".$profesor->id."/eliminar",  "method" => "delete", "id" => "form_eliminar_prof".$profesor->id ])!!}
                                ...
                                @else
                                    <tr>
                                        ...
                                        <td>
                                            @if(Entrust::can('eliminar_prof_curso'))
                                                {!!Form::open(["url"=>"actividades/".$curso->id."/modulos/".$modulo->id."/profesores/".$profesor[0]->id."/eliminar",  "method" => "delete", "id" => "form_eliminar_prof".$profesor[0]->id ])!!}
                        ...
                        @else
                            ...
                            @else
                                <td></td>
                                <td> <strong> No existen profesores que dicten la actividad </strong></td>
                            @endif
                        @endif
                        </tbody>
                    </table>
                ...
                <div class="col-md-2 " style="">
                    @if(Entrust::can('ver_lista_cursos'))
                        <a href="{{URL::to('/')}}/actividades/{{$curso->id}}/modulos/profesores" type="button" class="btn btn-default" style="text-decoration: none"><span class="glyphicon glyphicon-chevron-left"></span> Regresar </a>
                    @endif
                </div>
                <div class="col-md-2 " style="">
                    @if(Entrust::can('agregar_prof_curso'))
                        {!!Form::open(["url"=>"actividades/".$curso->id."/modulos/".$modulo->id."/profesores/agregar",  "method" => "GET" ])!!}
                        <button type="submit" class="btn btn-success" data-toggle="tooltip" data-placement="bottom" title="Agregar profesor a la actividad" >
