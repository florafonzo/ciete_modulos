            ...
            <div class="col-md-8 col-sm-8 opciones_part2">
                ...
                <div class="row">
                    <div class="col-md-6 col-md-offset-6">
                        {!!Form::open(["url"=>"actividades/".$curso->id."/grupos/".$seccion."/participantes/agregar/buscar",  "method" => "GET" ])!!}
                                    ...
                                    <tr>
                                        ...
                                        <td class="">
                                            @if(Entrust::can('agregar_part_curso'))
                                                {!!Form::open(["url"=>"actividades/".$curso->id."/grupos/".$seccion."/participantes/".$partici->id."/agregar",  "method" => "GET", 'id' => 'part_agregar'.$partici->id] )!!}
                                                    <button type="button" onclick="agregarPart('{{$partici->id}}')" class="btn btn-info" title="Agregar participante la actividad" data-toggle="tooltip" data-placement="bottom" aria-hidden="true">
                ...
                <div class="col-md-2 " style="">
                    @if(Entrust::can('participantes_curso'))
                        <a href="{{URL::to('/')}}/actividades/{{$curso->id}}/grupos/{{$seccion}}/participantes" type="button" class="btn btn-default" style="text-decoration: none"> <span class="glyphicon glyphicon-chevron-left"></span> Regresar </a>
                    @endif
                </div>
                {{--<div class="col-md-2" style="">--}}
                    {{--@if(Entrust::can('agregar_part_curso'))--}}
