                ...
                <div class="row">
                    <div class="col-md-8 col-md-offset-2 col-sm-12 col-xs-12" style="text-align: justify">
                        <div class="row">
                            ...
                            <div class="row">
                                <a class="btn" style="background-color: white; color: #418C47; font-weight: bold;" href="#p1" data-toggle="collapse"><span class="glyphicon glyphicon-plus"></span>  ¿Debo crear una cuenta para inscribirme en alguna actividad?</a>
                            ...
                            <div class="row">
                                <a class="btn" style="background-color: white; color: #418C47; font-weight: bold;" href="#p2" data-toggle="collapse"><span class="glyphicon glyphicon-plus"></span>  ¿Puedo pagar las actividades en varias partes?</a>
                            ...
                            <div class="row">
                                <a class="btn" style="background-color: white; color: #418C47; font-weight: bold;" href="#p3" data-toggle="collapse"><span class="glyphicon glyphicon-plus"></span>  ¿Debo cancelar el monto de la actividad antes de ingresar mis datos?</a>
                            ...
                            <div class="row">
                                <a class="btn" style="background-color: white; color: #418C47; font-weight: bold;" href="#p4" data-toggle="collapse"><span class="glyphicon glyphicon-plus"></span>  ¿Cómo puedo saber si mi inscripción fue confirmada?</a>
                            ...
                            <div class="row">
                                <a class="btn" style="background-color: white; color: #418C47; font-weight: bold;" href="#p5" data-toggle="collapse"><span class="glyphicon glyphicon-plus"></span>  ¿Mi inscripción puede ser rechazada?</a>
                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                <a class="btn" style="background-color: white; color: #1968b3; font-weight: bold;" href="#p6" data-toggle="collapse"><span class="glyphicon glyphicon-plus"></span>  ¿Cómo realizo los pagos durante una actividad?</a>
                            ...
                            <div class="row">
                                <a class="btn" style="background-color: white; color: #1968b3; font-weight: bold;" href="#p7" data-toggle="collapse"><span class="glyphicon glyphicon-plus"></span>  ¿Puedo ver mis calificaciones?</a>
